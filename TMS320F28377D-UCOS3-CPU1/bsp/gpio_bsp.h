...
//dth11 
#define DTH11_HIGH GpioDataRegs.GPBSET.bit.GPIO50 = 1
#define DTH11_LOW  GpioDataRegs.GPBCLEAR.bit.GPIO50 = 1
#define Read_Data  GPIO_ReadPin(50)
