...
static u8 *SerializeUint(u8 *ptr, u64 value, u8 len)
{
    for (s32 i = 0; i < len; i++)
    {
        *ptr++ = value >> (i * 8);
...
static u8 *SerializeInt(u8 *ptr, s64 value, u8 len)
{
    for (s32 i = 0; i < len; i++)
    {
        *ptr++ = value >> (i * 8);
...
static u8 *SerializeFloat(u8 *ptr, f32 value)
{
    u32 ivalue = *((u32 *)&value);

    for (s32 i = 0; i < sizeof(ivalue); i++)
    {
        *ptr++ = ivalue >> (i * 8);
    }
...
static u8 *SerializeDouble(u8 *ptr, f64 value)
{
...
static u8 *UnSerializeUint(const u8 *ptr, u64 *value, u8 len)
{
    *value = 0;
...
static u8 *UnSerializeInt(const u8 *ptr, s64 *value, u8 len)
{
    *value = 0;
...
static u8 *UnSerializeFloat(const u8 *ptr, f32 *value)
{
    u32 ivalue = 0;
...
static u8 *UnSerializeDouble(const u8 *ptr, f64 *value)
{
    u64 ivalue = 0;
...
/**
  ...
  * @return     0,成功; -1,失败
  */
s32 cotParam_Init(cotParamManager_t *pManager, cotParamInfo_t *pParamTable, u16 count)
{
...
/**
  ...
  * @return     0,成功; -1,失败
  */
s32 cotParam_ResetDefault(const cotParamManager_t *pManager)
{
    if (pManager == NULL)
    {
        return -1;
    ...
    for (u16 i = 0; i < pManager->count; ++i)
    {
...
/**
  ...
  * @return     0,成功; -1,失败
  */
s32 cotParam_Check(const cotParamManager_t* pManager, cotParamError_f pfnCheckError)
{
    ...
    for (s32 id = 0; id < pManager->count; id++)
    {
...
static cotParamInfo_t *FindParamByID(const cotParamManager_t *pManager, u16 id)
{
    for (u16 i = 0; i < pManager->count; ++i)
    {
...
/**
  ...
  * @return     参数信息
  */
const cotParamInfo_t *cotParam_FindParamByID(const cotParamManager_t *pManager, u16 id)
{
...
/**
  ...
  * @return     0,成功; -1,失败
  */
s32 cotParam_SingleParamCheckProcess(const cotParamInfo_t *pParam, cotParamResetOpt_e eResetOpt)
{
    cotParamCheckRet_e eCheckResult;
...
/**
  ...
  * @return     0,成功; -1,失败
  */
s32 cotParam_SingleParamUpdate(const cotParamInfo_t *pParam, const void *pNewValue, cotParamResetOpt_e eResetOpt)
{
    cotParamCheckRet_e eCheckResult;
 ...
 * @return     0,成功; -1,失败
 */
s32 cotParam_SingleParamCheckInput(const cotParamInfo_t *pParam, const void *pValue, cotParamCheckRet_e *peCheckResult)
{
 ...
 * @return     0,成功; -1,失败
 */
s32 cotParam_SingleParamSelfCheck(const cotParamInfo_t *pParam, cotParamCheckRet_e *peCheckResult)
{
...
/**
  ...
  * @return     0,成功; -1,失败
  */
s32 cotParam_SingleParamResetDefValue(const cotParamInfo_t *pParam)
{
    if (pParam == NULL)
    {
        return -1;
...
/**
  ...
  * @return     0,成功; -1,失败
  */
s32 cotParam_SingleParamResetMinValue(const cotParamInfo_t *pParam)
{
    if (pParam == NULL)
    {
        return -1;
...
/**
  ...
  * @return     0,成功; -1,失败
  */
s32 cotParam_SingleParamResetMaxValue(const cotParamInfo_t *pParam)
{
    if (pParam == NULL)
    {
        return -1;
...
static u16 ParamInfoFormStream(cotParamInfo_t *pParam, const u8 *pbuf)
{
    switch (pParam->type)
    {
    case COT_PARAM_INT8:
...
static u8 *MoveBufToBase(u8 *pbuf, u32 length)
{
...
/**
  ...
  */
s32 cotParam_Load(const cotParamManager_t *pManager, cotParamLoad_f pfnLoadCallback)
{
#if COT_PARAM_USE_STRING_TYPE
    u8 buf[sizeof(cotParamInfo_t) + COT_PARAM_STRING_MAX_LENGTH];
#else
    u8 buf[sizeof(cotParamInfo_t)];
#endif
    u8 *ptr = buf;
...
static u16 ParamInfoToStream(u8 *pbuf, cotParamInfo_t *pParam)
{
    switch (pParam->type)
    {
    case COT_PARAM_INT8:
...
/**
  ...
  */
s32 cotParam_Save(const cotParamManager_t *pManager, cotParamSave_f pfnSaveCallback)
{
#if COT_PARAM_USE_STRING_TYPE
    u8 buf[sizeof(cotParamInfo_t) + COT_PARAM_STRING_MAX_LENGTH];
#else
    ...
    for (s32 i = 0; i < pManager->count; i++)
    {
        ptr = buf;
        length = 0;
#if COT_PARAM_USE_KEY_VALUE
 ...
 */
u32 cotParam_GetSerializeSize(const cotParamManager_t* pManager)
{
    u32 length = 1;
    u16 idx = 0;
 ...
 * @return     0,成功; -1,失败 
 */
u32 cotParam_Serialize(const cotParamManager_t* pManager, u8 *pbuf)
{
    if (pManager == NULL)
    {
        return 0;
 ...
 * @return     0,成功; -1,失败 
 */
s32 cotParam_Deserialization(const cotParamManager_t* pManager, const u8 *pbuf, u32 length)
{
    if (pManager == NULL)
    {
        return -1;
...
/**
  ...
  * @return     0,成功; -1,失败; 
  */
s32 cotParam_SingleParamChangeImpl(const cotParamManager_t* pManager, const void *pCurParam, va_list paramList)
{
...
/**
  ...
  * @return     0,成功; -1,失败; 
  */
s32 cotParam_SingleParamChange(const cotParamManager_t* pManager, const void *pCurParam, ...)
{
    s32 ret = 0;
    va_list paramList;
